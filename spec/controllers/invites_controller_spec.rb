  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved invite as @invite" do
        post :create, {:invite => invalid_attributes}, valid_session
        expect(assigns(:invite)).to be_a_new(Invite)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested invite" do
        invite = Invite.create! valid_attributes
        put :update, {:id => invite.to_param, :invite => new_attributes}, valid_session
        invite.reload
    ...
    describe "with invalid params" do
      it "assigns the invite as @invite" do
        invite = Invite.create! valid_attributes
        put :update, {:id => invite.to_param, :invite => invalid_attributes}, valid_session
        expect(assigns(:invite)).to eq(invite)
      end
